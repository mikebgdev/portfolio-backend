...
class SiteConfig(Base):
    ...
    # Favicon
    favicon_file = Column(String(500), nullable=True, comment="Favicon file path", info={"label": "Archivo Favicon"})
    ...
    og_image_file = Column(String(500), nullable=True, comment="Open Graph image file path", info={"label": "Archivo Imagen OG"})
    ...
    twitter_image_file = Column(String(500), nullable=True, comment="Twitter card image file path", info={"label": "Archivo Imagen Twitter"})
