...
class ExperienceBase(BaseModel):
    ...
    description_es: Optional[str] = Field(None, description="Job description in Spanish")
    
    # Date fields
    start_date: datetime = Field(..., description="Start date")
    end_date: Optional[datetime] = Field(None, description="End date (null for current)")
